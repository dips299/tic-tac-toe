...
public class CSD311_AI_1710110146_1710110263 {
    ...
    private static void systemBegin() //function that marks the begining of the system moves on the board
    {
        ...
        else
        {
            ...
            if(play > 0) //if there exists a move that allows system to win or the human to win, play there
            {
                go(play); 
            }
    ...
    static void goAnywhere(int e)   //go anywhere expect the index number e
    {       
